...
| [`replication.md`](replication.md) | COMMENT les deux racines se répliquent : le transport, les deux qui écrivent et la règle de conflit, l'horloge, le rattrapage, ce que le client voit. Spécifié, pas écrit. |
